...
class Prey(Creature):
    ...
    def getTarget(self, CounterCreatures, Food):
        FilteredFood, FilteredPredators = utils.FoodAndPredatorFilterUsingEuclideanDistances(self.velocitydirection,(self.rect.centerx,self.rect.centery), CounterCreatures, Food, self.fieldRadius)
